...
export const routerVersion = "v0.8.6";
export const routerVersionNext = "v0.8.6";

export const mapDataVersionDate = "2025-09-10";
export const mapDataVersionDateNext = "2025-09-10";
