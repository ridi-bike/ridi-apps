...
import type  type { Sql } from "postgres";
...
export async function plansListForUserNotDeleted(
  sql: Sql,
  args: PlansListForUserNotDeletedArgs,
): Promise<PlansListForUserNotDeletedRow[]> {
  return (
    await sql.unsafe(plansListForUserNotDeletedQuery, [args.userId]).values()
  ).map((row) => ({
    id: row[0],
    userId: row[1],
    createdAt: row[2],
...
export async function routesListForUserNotDeleted(
  sql: Sql,
  args: RoutesListForUserNotDeletedArgs,
): Promise<RoutesListForUserNotDeletedRow[]> {
  return (
    await sql.unsafe(routesListForUserNotDeletedQuery, [args.userId]).values()
  ).map((row) => ({
    id: row[0],
    userId: row[1],
    createdAt: row[2],
...
export async function routeBreakdoiwnStatsListForUserNotDeleted(
  sql: Sql,
  args: RouteBreakdoiwnStatsListForUserNotDeletedArgs,
): Promise<RouteBreakdoiwnStatsListForUserNotDeletedRow[]> {
  return (
    await sql
      .unsafe(routeBreakdoiwnStatsListForUserNotDeletedQuery, [args.userId])
      .values()
  ).map((row) => ({
    id: row[0],
    userId: row[1],
...
export async function ruleSetsListForUserNotDeleted(
  sql: Sql,
  args: RuleSetsListForUserNotDeletedArgs,
): Promise<RuleSetsListForUserNotDeletedRow[]> {
  return (
    await sql.unsafe(ruleSetsListForUserNotDeletedQuery, [args.userId]).values()
  ).map((row) => ({
    id: row[0],
    userId: row[1],
    name: row[2],
...
export async function ruleSetRoadTagsListForUserNotDeleted(
  sql: Sql,
  args: RuleSetRoadTagsListForUserNotDeletedArgs,
): Promise<RuleSetRoadTagsListForUserNotDeletedRow[]> {
  return (
    await sql
      .unsafe(ruleSetRoadTagsListForUserNotDeletedQuery, [args.userId])
      .values()
  ).map((row) => ({
    userId: row[0],
    ruleSetId: row[1],
...
export async function geoBoundariesFindCoords(
  sql: Sql,
  args: GeoBoundariesFindCoordsArgs,
): Promise<GeoBoundariesFindCoordsRow[]> {
  return (
    await sql
      .unsafe(geoBoundariesFindCoordsQuery, [args.lon, args.lat])
      .values()
  ).map((row) => ({
    id: row[0],
    name: row[1],
...
export async function routesListDownloaded(
  sql: Sql,
  args: RoutesListDownloadedArgs,
): Promise<RoutesListDownloadedRow[]> {
  return (
    await sql.unsafe(routesListDownloadedQuery, [args.userId]).values()
  ).map((row) => ({
    id: row[0],
    userId: row[1],
    createdAt: row[2],
...
export async function routeSetDownloadedAt(
  sql: Sql,
  args: RouteSetDownloadedAtArgs,
): Promise<RouteSetDownloadedAtRow | null> {
  const rows = await sql
    .unsafe(routeSetDownloadedAtQuery, [args.downloadedAt, args.id])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
export async function routeUpdateMapPreview(
  sql: Sql,
  args: RouteUpdateMapPreviewArgs,
): Promise<void> {
  await sql.unsafe(routeUpdateMapPreviewQuery, [
    args.mapPreviewDark,
    args.mapPreviewLight,
    args.id,
  ]);
}
...
export async function planUpdateMapPreview(
  sql: Sql,
  args: PlanUpdateMapPreviewArgs,
): Promise<void> {
  await sql.unsafe(planUpdateMapPreviewQuery, [
    args.mapPreviewDark,
    args.mapPreviewLight,
    args.id,
  ]);
...
export async function userClaimPlans(
  sql: Sql,
  args: UserClaimPlansArgs,
): Promise<void> {
...
export async function userClaimRoutes(
  sql: Sql,
  args: UserClaimRoutesArgs,
): Promise<void> {
...
export async function userClaimRouteBreakdownStats(
  sql: Sql,
  args: UserClaimRouteBreakdownStatsArgs,
): Promise<void> {
  await sql.unsafe(userClaimRouteBreakdownStatsQuery, [
    args.toUserId,
    args.fromUserId,
  ]);
}
...
export async function userClaimRuleSets(
  sql: Sql,
  args: UserClaimRuleSetsArgs,
): Promise<void> {
...
export async function userClaimRuleSetRoadTags(
  sql: Sql,
  args: UserClaimRuleSetRoadTagsArgs,
): Promise<void> {
  await sql.unsafe(userClaimRuleSetRoadTagsQuery, [
    args.toUserId,
    args.fromUserId,
  ]);
}
...
export async function privateCodeGet(
  sql: Sql,
  args: PrivateCodeGetArgs,
): Promise<PrivateCodeGetRow | null> {
...
export async function privateCodeClaim(
  sql: Sql,
  args: PrivateCodeClaimArgs,
): Promise<void> {
...
export async function privateUserInsert(
  sql: Sql,
  args: PrivateUserInsertArgs,
): Promise<PrivateUserInsertRow | null> {
...
export async function privateUserDecreaseDownloads(
  sql: Sql,
  args: PrivateUserDecreaseDownloadsArgs,
): Promise<PrivateUserDecreaseDownloadsRow | null> {
  const rows = await sql
    .unsafe(privateUserDecreaseDownloadsQuery, [args.userId])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
export async function privateUsersUpdateWithSubscriptionCode(
  sql: Sql,
  args: PrivateUsersUpdateWithSubscriptionCodeArgs,
): Promise<void> {
  await sql.unsafe(privateUsersUpdateWithSubscriptionCodeQuery, [
    args.subType,
    args.userId,
  ]);
}
...
export async function privateUsersUpdateStripeCustomerId(
  sql: Sql,
  args: PrivateUsersUpdateStripeCustomerIdArgs,
): Promise<void> {
  await sql.unsafe(privateUsersUpdateStripeCustomerIdQuery, [
...
export async function privateUsersUpdateSubType(
  sql: Sql,
  args: PrivateUsersUpdateSubTypeArgs,
): Promise<void> {
...
export async function privateUsersUpdateStripeData(
  sql: Sql,
  args: PrivateUsersUpdateStripeDataArgs,
): Promise<void> {
  await sql.unsafe(privateUsersUpdateStripeDataQuery, [
    args.stripeStatus,
    args.userId,
    args.stripeSubscriptionId,
    args.stripePriceId,
    args.stripeCurrentPeriodEnd,
    args.stripeCurrentPeriodStart,
    args.stripeCancelAtPeriodEnd,
    args.stripePaymentMethod,
    args.subType,
  ]);
}
...
export async function privateUsersUpdateInitiated(
  sql: Sql,
  args: PrivateUsersUpdateInitiatedArgs,
): Promise<void> {
  await sql.unsafe(privateUsersUpdateInitiatedQuery, [
    args.stripeCheckoutId,
    args.userId,
  ]);
}
...
export async function privateUsersUpdateCompleted(
  sql: Sql,
  args: PrivateUsersUpdateCompletedArgs,
): Promise<void> {
...
export async function privateUsersUpdateStripeStatusNone(
  sql: Sql,
  args: PrivateUsersUpdateStripeStatusNoneArgs,
): Promise<void> {
...
export async function privateUsersGetRow(
  sql: Sql,
  args: PrivateUsersGetRowArgs,
): Promise<PrivateUsersGetRowRow | null> {
  const rows = await sql
    .unsafe(privateUsersGetRowQuery, [args.userId])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
export async function privateUsersGetRowByStripeCustomerId(
  sql: Sql,
  args: PrivateUsersGetRowByStripeCustomerIdArgs,
): Promise<PrivateUsersGetRowByStripeCustomerIdRow | null> {
  const rows = await sql
    .unsafe(privateUsersGetRowByStripeCustomerIdQuery, [args.stripeCustomerId])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
export async function planSetRegion(
  sql: Sql,
  args: PlanSetRegionArgs,
): Promise<void> {
...
export async function planDelete(
  sql: Sql,
  args: PlanDeleteArgs,
): Promise<PlanDeleteRow | null> {
  const rows = await sql
    .unsafe(planDeleteQuery, [args.id, args.userId])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
): Promise<RouteDeleteRow | null> {
  const rows = await sql
    .unsafe(routeDeleteQuery, [args.id, args.userId])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
export async function routeDeleteByPlanId(
  sql: Sql,
  args: RouteDeleteByPlanIdArgs,
): Promise<RouteDeleteByPlanIdRow | null> {
  const rows = await sql
    .unsafe(routeDeleteByPlanIdQuery, [args.planId, args.userId])
    .values();
  if (rows.length !== 1) {
    return null;
  }
...
export async function regionInsertOrUpdate(
  sql: Sql,
  args: RegionInsertOrUpdateArgs,
): Promise<RegionInsertOrUpdateRow | null> {
  const rows = await sql
    .unsafe(regionInsertOrUpdateQuery, [
      args.region,
      args.geojson,
      args.polygon,
    ])
...
export async function ruleSetsList(
  sql: Sql,
  args: RuleSetsListArgs,
): Promise<RuleSetsListRow[]> {
  return (await sql.unsafe(ruleSetsListQuery, [args.userId]).values()).map(
    (row) => ({
      id: row[0],
      userId: row[1],
      name: row[2],
...
export async function ruleSetRoadTagsList(
  sql: Sql,
  args: RuleSetRoadTagsListArgs,
): Promise<RuleSetRoadTagsListRow[]> {
  return (
    await sql.unsafe(ruleSetRoadTagsListQuery, [args.userId]).values()
  ).map((row) => ({
    userId: row[0],
    ruleSetId: row[1],
    tagKey: row[2],
...
export async function ruleSetRoadTagsListByRuleSetIdWithDeleted(
  sql: Sql,
  args: RuleSetRoadTagsListByRuleSetIdWithDeletedArgs,
): Promise<RuleSetRoadTagsListByRuleSetIdWithDeletedRow[]> {
  return (
    await sql
      .unsafe(ruleSetRoadTagsListByRuleSetIdWithDeletedQuery, [
        args.userId,
        args.ruleSetId,
      ])
      .values()
...
export async function ruleSetUpsert(
  sql: Sql,
  args: RuleSetUpsertArgs,
): Promise<void> {
...
export async function ruleSetRoadTagsUpsert(
  sql: Sql,
  args: RuleSetRoadTagsUpsertArgs,
): Promise<void> {
  await sql.unsafe(ruleSetRoadTagsUpsertQuery, [
    args.userId,
    args.ruleSetId,
    args.tagKey,
    args.value,
...
export async function ruleSetGet(
  sql: Sql,
  args: RuleSetGetArgs,
): Promise<RuleSetGetRow | null> {
...
export async function ruleSetSetDeleted(
  sql: Sql,
  args: RuleSetSetDeletedArgs,
): Promise<void> {
...
export async function routesGet(
  sql: Sql,
  args: RoutesGetArgs,
): Promise<RoutesGetRow[]> {
  return (
    await sql.unsafe(routesGetQuery, [args.userId, args.id]).values()
  ).map((row) => ({
    id: row[0],
    name: row[1],
    createdAt: row[2],
...
export async function routeStatsGet(
  sql: Sql,
  args: RouteStatsGetArgs,
): Promise<RouteStatsGetRow[]> {
  return (
    await sql.unsafe(routeStatsGetQuery, [args.userId, args.routeId]).values()
  ).map((row) => ({
    id: row[0],
    userId: row[1],
    routeId: row[2],
...
export async function planList(
  ...
  return (await sql.unsafe(planListQuery, [args.userId]).values()).map(
    (row) => ({
      id: row[0],
      name: row[1],
      startLat: row[2],
...
export async function planUpsert(
  sql: Sql,
  args: PlanUpsertArgs,
): Promise<void> {
  await sql.unsafe(planUpsertQuery, [
    args.id,
    args.userId,
    args.createdAt,
    args.modifiedAt,
...
export async function regionFindFromCoords(
  sql: Sql,
  args: RegionFindFromCoordsArgs,
): Promise<RegionFindFromCoordsRow[]> {
  return (
    await sql.unsafe(regionFindFromCoordsQuery, [args.lon, args.lat]).values()
  ).map((row) => ({
    region: row[0],
    geojson: row[1],
    polygon: row[2],
...
export async function regionGetCount(
  sql: Sql,
): Promise<RegionGetCountRow | null> {
...
export async function planGetById(
  sql: Sql,
  args: PlanGetByIdArgs,
): Promise<PlanGetByIdRow | null> {
...
export async function planSetState(
  sql: Sql,
  args: PlanSetStateArgs,
): Promise<void> {
...
export async function routeInsert(
  sql: Sql,
  args: RouteInsertArgs,
): Promise<RouteInsertRow | null> {
  const rows = await sql
    .unsafe(routeInsertQuery, [
      args.name,
      args.userId,
      args.planId,
      args.statsLenM,
      args.statsJunctionCount,
      args.statsScore,
      args.latLonArray,
    ])
    .values();
...
export async function routeBreakdownStatsInsert(
  sql: Sql,
  args: RouteBreakdownStatsInsertArgs,
): Promise<RouteBreakdownStatsInsertRow | null> {
  const rows = await sql
    .unsafe(routeBreakdownStatsInsertQuery, [
      args.userId,
      args.routeId,
      args.statType,
      args.statName,
