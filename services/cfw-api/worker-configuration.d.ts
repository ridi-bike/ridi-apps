/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 02dd79647a6fa052cc9c413e694cfa79)
// Runtime types generated with workerd@1.20250416.0 2025-01-29 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    SUPABASE_URL: string;
    SUPABASE_DB_URL: string;
    RIDI_APP_URL: string;
    RIDI_LANDING_URL: string;
    ...
    RIDI_ENV: string;
    RESEND_KEY: string;
    RESEND_AUD_GENERAL_ID: string;
    UserStoreDurableObject: DurableObjectNamespace<
      import("./src/sync.ts").UserStoreDurableObject
    >;
  }
}
