/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 96f6e6d5f38028fce4b45ea2ddee9b5b)
...
declare namespace Cloudflare {
	interface Env {
		...
		TinyBaseDurableObjects: DurableObjectNamespace<import("./src/index").TinyBaseDurableObject>;
	}
}
